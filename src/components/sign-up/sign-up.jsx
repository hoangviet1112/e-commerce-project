...
const SignUp = () => {
    ...
    async function handleSubmit(event) {
        ...
        try {
            const {newUser} = await auth.createUserWithEmailAndPassword(newProfile.email, newProfile.password)
            await createUserProfileDocument(newUser, newProfile.displayName)
            setNewProfile({
                displayName: "",
                email: "",
                password: "",
