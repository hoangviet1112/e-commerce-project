    ...
    return (
        <div className="contact-page-footer">
            <span className="option">
                ...
                <a href="#"><i style={{fontSize:"45px", cursor:"pointer", padding: "0px 10px"}} class="fa-solid fa-house"></i></a>
                <a href="#"><i style={{fontSize:"45px", cursor:"pointer", padding: "0px 10px"}} class="fa-brands fa-linkedin"></i></a>
            </span>
